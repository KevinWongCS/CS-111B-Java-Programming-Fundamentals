...
//    public GridItem get(int index)  should return the stored GridItems by index.
	...
	// returns number of GridItems stored in GridWriter, doesn't include null values
	public int size() {
		int trueSize;
	...
	// this method will throw an exception when index is out of bound
	public GridItem get(int index) {
		
		// Error checking: null items object or index out of bounds or index negative 
		if (items[index] == null || index >= size() || index < 0) {
